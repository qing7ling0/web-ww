...
exports.orderList = exports.goodsList = exports.goodsProfile = exports.materialList = undefined;
...
var goodsProfile = exports.goodsProfile = {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _index.salesData.getGoodsProfile(params.id);
...
var goodsList = exports.goodsList = {
  type: new _graphql.GraphQLObjectType({
    ...
    fields: {
      ...
      list: { type: new _graphql.GraphQLList(types.goodsType) }
    }
  }),
  args: {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return _index.salesData.getGoodsList({ page: params.page, pageSize: params.pageSize }, { conditions: params.conditions });
