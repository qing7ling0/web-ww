...
var custom = schemasUtils.createDefaultMutaion('custom', types.customType, types.customInputType, _sales.customModel);
var urgent = schemasUtils.createDefaultMutaion('urgent', types.urgentType, types.urgentInputType, _sales.urgentModel);
...
var mutations = _extends({}, material, color, goodsStyle, goodsSeason, goodsType, goodsShoes, maintainPrice, orderShoes, custom, urgent, {
  orderAdd: orderAdd, orderRemove: orderRemove, orderUpdate: orderUpdate
});
