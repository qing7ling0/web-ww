...
exports.urlString2Conditions = exports.getTransportCompany = exports.getPayType = exports.getOrderType = exports.getOrderSource = exports.getMaintainPriceType = exports.getColorType = exports.getGoodsProperty = exports.getCustomerType = exports.getShopPro = exports.getMarketLevel = undefined;
...
var getOrderType = exports.getOrderType = function getOrderType(id) {
  for (var i = 0; i < _constants2.default.ORDER_TYPE.length; i++) {
    if (_constants2.default.ORDER_TYPE[i].value === id) return _constants2.default.ORDER_TYPE[i];
  }
