...
//格式化请求日志
var formatReqLog = function formatReqLog(ctx, resTime) {
...
//封装用户修改日志
logUtil.userModify = function (type, data) {
...
//格式化用户修改日志
var formatUserModify = function formatUserModify(type, data, time) {
    var logText = new String();
    //用户修改内容
...
//格式化调试日志
var formatDebug = function formatDebug(message, time) {
    var logText = new String();
    //调试内容
    logText += "[" + time + "] [debug] : " + "\n" + message + "\n";
