...
var _require = require('./common'),
    commonSchema = _require.commonSchema,
    commonModel = _require.commonModel;

var Schema = mongoose.Schema;

var materialFields = _extends({
...
var goodsSchema = new Schema(_extends({}, goodsBaseFields, goodsShoesFields, goodsBeltFields, goodsWatchStrapFields, baseFields));
...
}, shoesFields, beltFields, watchStrapFields, maintainFields, rechargeFields, ornamentFields, baseFields);
