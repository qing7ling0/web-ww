  ...
  _createClass(ShopData, [{
    ...
    value: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(page, options) {
        var skip, limit, findOptions, conditions, total, shops;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 9;
                return _index.shopModel.find(conditions).count();

              case 9:
                total = _context.sent;
                _context.next = 12;
                return _index.shopModel.find(conditions, null, findOptions);
              ...
              case 12:
                ...
                shops = shops.map(function (item) {
                  var isNew = false;
                  if (item.open_date) {
                    item.isNew = (0, _moment2.default)(item.open_date).add(180, 'days').isSameOrAfter(Date.now());
                  }
                  item = _index.shopModel.toClient(item);
                  return item;
                });
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _index.shopModel.findOne(conditions, projection, options);
              ...
              case 2:
                ...
                isNew = (0, _moment2.default)(shop.open_date).add(180, 'days').isSameOrAfter(Date.now());

                shop.isNew = isNew;
                return _context2.abrupt('return', shop);
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 5;
                return shop.save(options);

              case 5:
                newShop = _context3.sent;
                ...
                return _context3.abrupt('return', newShop);
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 3;
                return _index.shopModel.update(conditions, doc, options);
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _context6.next = 3;
                return _index.shopModel.remove({ _id: { $in: ids } });
