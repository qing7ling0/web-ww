...
var SalesData = function () {
  ...
  _createClass(SalesData, [{
    ...
    value: function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(customerDoc) {
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                if (!(customerDoc && customerDoc.phone && !_validate2.default.isMobile(customerDoc.phone))) {
                  _context4.next = 2;
                  break;
                }
              ...
              case 2:
                _context4.next = 4;
                return _index.customerModel.findOne({ phone: doc.customer.phone });
              ...
              case 4:
                ...
                _context4.next = 13;
                return customer.updateOne(_customerData);
      ...
      function updateOrAddCustomerByOrder(_x6) {
    ...
    value: function () {
      ...
      function updateOrder(_x9, _x10, _x11) {
    ...
    value: function () {
      ...
      function removeOrderByIds(_x13) {
