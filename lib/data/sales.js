...
var SalesData = function () {
  ...
  _createClass(SalesData, [{
    ...
    value: function () {
      ...
      function updateOrAddCustomerByOrder(_x6, _x7) {
    ...
    value: function () {
      ...
      function updateOrder(_x10, _x11, _x12) {
    ...
    value: function () {
      ...
      function removeOrderByIds(_x14) {
