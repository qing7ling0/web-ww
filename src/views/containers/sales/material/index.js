...
class MaterialContainer extends Component {
  ...
  render() {
    ...
    return (
      <Root>
        <ContentHeaderComponent willSelectNavKey={constants.MENU_IDS.salesMaterial} history={this.props.history} />
        <ContentContainer>
          <Switch>
            <Route exact path={match.path} component={MaterialListContainer} />
          </Switch>
        </ContentContainer>
      </Root>
    );
