...
class AdminAddModal extends Component {
  ...
  componentWillReceiveProps(nextProps){
    ...
    if (nextProps.result.type === ActionTypes.APP_VERSION_ADD && nextProps.loading !== this.props.loading && !nextProps.loading) {
...
export default connect(
  ...
  (dispatch) => {
    return bindActionCreators({
      reqGetList: Actions.getUserList,
      reqAdd: Actions.appVersionAdd
    }, dispatch);
  }
