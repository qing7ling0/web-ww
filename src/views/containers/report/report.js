...
export const GOODS_STATISTICS_COLS = [
  ...
  {key:'s_out_color', sum:false, label:'颜色', render:item=>item&&item.name || ''},
  {key:'s_in_color', sum:false, label:'内里色', render:item=>item&&item.name || ''},
  {key:'s_bottom_color', sum:false, label:'底侧色', render:item=>item&&item.name || ''},
  {key:'s_bottom_side_color', sum:false, label:'底板色', render:item=>item&&item.name || ''},
