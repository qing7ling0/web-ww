...
class DiscountContainer extends Component {
  ...
  render() {
    ...
    return (
      <Root>
        <ContentHeaderComponent willSelectNavKey={constants.MENU_IDS.activityDiscount} history={this.props.history} />
        <ContentContainer>
          <Switch>
            <Route exact path={match.path} component={DiscountListContainer} />
          </Switch>
        </ContentContainer>
      </Root>
    );
