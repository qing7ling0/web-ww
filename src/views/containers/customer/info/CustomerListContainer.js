...
class CustomerListContainer extends Component {
  ...
  componentDidMount(){
    ...
    this.props.reqGetSalesBaseList('vipLevelList:commonList', graphqlTypes.vipLevelType, {type:constants.BASE_CONSTANTS.COMMON_DATA_TYPES.VIP});
  }
  ...
  render() {
    const columns = [
      ...
      { title: '开卡日期', dataIndex: 'vip_card_date', key: 'vip_card_date', render:value=>value && moment(value).format("YYYY-MM-DD") || ""},
