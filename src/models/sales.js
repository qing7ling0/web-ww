...
const shoesFields = {
  ...
  s_foot_size: {type: String, description:'尺码'},
  s_left_length: {type: String, description:'左脚长度'},
  s_left_zhiWei: {type: String, decription:'左脚趾围'},
  s_left_fuWei: {type: String, decription:'左脚附维'},
  s_right_length: {type: String, description:'右脚长度'},
...
const beltFields = {
  ...
  b_A: {type: String, decription:'皮带测量数据A'},
  b_B: {type: String, decription:'皮带测量数据B'},
  b_C: {type: String, decription:'皮带测量数据C'},
  b_D: {type: String, decription:'皮带测量数据D'},
...
const watchStrapFields = {
  ...
  ws_A: {type: String, decription:'表带测量数据A'},
  ws_B: {type: String, decription:'表带测量数据B'},
  ws_C: {type: String, decription:'表带测量数据C'},
  ws_D: {type: String, decription:'表带测量数据D'},
  ws_E: {type: String, decription:'表带测量数据E'},
  ws_F: {type: String, decription:'表带测量数据F'},
  ws_G: {type: String, decription:'表带测量数据G'},
