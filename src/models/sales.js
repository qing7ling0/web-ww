...
var orderBeltSchema = new Schema({
  ...baseOrderFields,
...
// 表带
var orderWatchStrapSchema = new Schema({
  ...baseOrderFields,
...
// 配饰
var orderOrnamentSchema = new Schema({
  ...baseOrderFields,
...
// 辅料
var orderFuliaoSchema = new Schema({
  ...baseOrderFields,
...
// 护理
var orderMaintainSchema = new Schema({
  ...baseOrderFields,
